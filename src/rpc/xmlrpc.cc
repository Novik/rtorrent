...
const char* untrusted_commands_array[] = {
	"execute",
	"execute.capture",
...
static std::vector<std::string> untrusted_commands(untrusted_commands_array, untrusted_commands_array + sizeof(untrusted_commands_array)/sizeof(untrusted_commands_array[0]));
